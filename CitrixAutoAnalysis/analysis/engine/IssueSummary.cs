...
namespace CitrixAutoAnalysis.analysis.engine
{
    class IssueSummary
    {
        ...
        public IssueSummary(Log brkPnt, Log error, Guid pattern, int job, string name, HashSet<string> words)
        {
        ...
        {
            string sql = "Insert into CadIssues values(null," + jobId + ", '" + keyWords + "','" + name + "','" + keyWords + "',0,'" + patternId.ToString() + "')";
